  ...
  <div className="space-y-4">
    ...
    <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800 rounded-xl">
      <div className="flex items-center">
        <ShieldCheck className="w-5 h-5 mr-3" style={{ color: primary }} />
        <div>
          <p className={`text-sm font-medium ${textDark}`}>Authentication</p>
          <p className={`text-xs ${textLight}`}>User login & security</p>
        </div>
      </div>
