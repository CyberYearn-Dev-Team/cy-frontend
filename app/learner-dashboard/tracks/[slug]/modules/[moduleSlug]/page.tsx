                ...
                {module.lessons.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className={`${textMedium} max-w-md mx-auto mb-4`}>
                      We're working hard to create engaging lessons for this module. 
                      Lessons will appear here once they're ready for you to explore.
                    </p>
                    <div className="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 rounded-lg p-4 max-w-md mx-auto">
                      <p className="text-sm text-blue-800 dark:text-blue-200">
                        <strong>What to expect:</strong> Interactive lessons with hands-on exercises, 
                        practical examples, and step-by-step guidance to help you master the concepts.
                      </p>
                    </div>
                  </div>
                ) : (
              ...
              >
                ...
                {(!module.lab_guides || module.lab_guides.length === 0) ? (
                  <div className="text-center py-12">
                    ...
                    <p className={`${textMedium} max-w-md mx-auto mb-4`}>
                      Practical lab exercises are being prepared for this module. 
                      Check back soon for hands-on learning opportunities.
                    </p>
                    <div className="bg-purple-50 dark:bg-purple-900/30 border border-purple-200 dark:border-purple-700 rounded-lg p-4 max-w-md mx-auto">
                      <p className="text-sm text-purple-800 dark:text-purple-200">
                        <strong>Coming soon:</strong> Real-world scenarios, practical challenges, 
                        and guided exercises to apply what you've learned in a safe environment.
                      </p>
                    </div>
                  </div>
                ) : (
