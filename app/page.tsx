        ...
        <div className="container mx-auto px-4 sm:px-8 md:px-12 lg:px-20 py-8 sm:py-12 md:py-16 lg:py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            ...
            >
              ...
              <CardContent>
                ...
                >
                  Structured learning paths covering cybersecurity fundamentals
                  to advanced topics
                </CardDescription>
              </CardContent>
            </Card>
          ...
          >
            <Card className="w-full border-0 bg-transparent shadow-none">
              ...
              <CardContent>
                <p
                  className={`text-yellow-700 dark:text-yellow-400 leading-relaxed max-w-5xl`}
                >
                  CyberYearn is designed exclusively for educational purposes.
                  All content, tools, and exercises are provided in a controlled
                  environment to help learners understand cybersecurity concepts
                  safely and responsibly. Any misuse of the knowledge gained
